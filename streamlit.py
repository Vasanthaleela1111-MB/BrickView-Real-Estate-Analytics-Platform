...
df = pd.read_json(r"C:\AIML\Projects\Brickview Real Estate Project\agents_20k.json")
sales=pd.read_csv(r"C:\AIML\Projects\Brickview Real Estate Project\sales_20k.csv")
list=pd.read_json(r"C:\AIML\Projects\Brickview Real Estate Project\listings_20k.json")
agents_20=pd.read_json(r"C:\AIML\Projects\Brickview Real Estate Project\agents_20k.json")
agents_enhanced=pd.read_json(r"C:\AIML\Projects\Brickview Real Estate Project\agents_enhanced_20k.json")
...
if page == "Project Introduction":
    ...
    **Database Used:** `brickview_realestate.db`
    ...
    #  Run query only if at least one filter chosen
    if params:
...
# Map Chart
    ...
    """
    elif selected=="30.Do loan-backed purchases take longer to close?":
        query="""
